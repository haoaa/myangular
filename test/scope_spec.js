...
xdescribe('Scope', function () {
  ...
  describe('digest', function () {
    ...
    it('my have wathers that omit the listener function', function () {
  ...
  describe('$eval', function () {
    ...
    it('passes the second $eval argument forward straight through', function () {
      scope.aValue = 40;
  ...
  describe('$watchGroup', function () {
    ...
    it('it only calls listener once per digest ', function () {
      var counter = 0;
      scope.$watchGroup([
        function (scope) { return scope.aValue; },
        function (scope) { return scope.anotherValue; }
    ...
    it('calls the listener once when the watcher array is empty', function () {
      var gotNewValues, gotOldValues;
      scope.$watchGroup([],
        function (newValues, oldValues, scope) {
          gotNewValues = newValues;
  ...
  describe('inheritance', function () {
    ...
    it('cannot watch parents attributes when isolated', function () {
      var parent = new Scope();
      var child = parent.$new(true);
  ...
  describe('Events', function () {
    ...
    it('propagates the same event down on $broadcast', function () {
      ...
      var isolatedEvent = isolatedChildListener.calls.mostRecent().args[0];
      expect(scopeEvent).toBe(childEvent);
      expect(isolatedEvent).toBe(childEvent);
    });
    ...
    it('no longer calls listeners scope destroyed', function () {
      var listener = jasmine.createSpy();
      scope.$on('someEvent', listener);
